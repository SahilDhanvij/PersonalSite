...
export const Footer: React.FC = () => {
  const socials = [
    { label: 'GitHub', href: 'https://github.com/SahilDhanvij', icon: (
    ...
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/sahil-dhanvij/', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
    )},
    { label: 'Twitter', href: 'https://x.com/sahild_07', icon: (
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="py-24 md:py-32">
          <div className="grid md:grid-cols-[1.2fr,1fr] gap-12 items-end">
            <div>
              <ScrollReveal>
                <span className="font-mono text-[11px] tracking-[0.2em] uppercase block mb-6" style={{ color: 'var(--accent)' }}>Get in touch</span>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
                <h3 className="font-display text-3xl md:text-5xl font-700 leading-tight mb-6" style={{ color: 'var(--text)' }}>
                  Let's build something <br />
                  <span className="font-serif italic" style={{ color: 'var(--accent)' }}>remarkable</span> together
                </h3>
              </ScrollReveal>
            ...
            <div className="flex flex-col gap-5">
              <ScrollReveal delay={0.25}>
                <a
                  ...
                  className="group flex items-center justify-between p-6 rounded-2xl border transition-all duration-400 hover-lift"
                ...
                >
                  <div>
                    <span className="font-mono text-[10px] tracking-[0.2em] uppercase block mb-1.5" style={{ color: 'var(--text-light)' }}>Email</span>
              ...
              <ScrollReveal delay={0.3}>
                <div className="flex items-center gap-3 px-6 py-4 rounded-2xl border" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg-card)' }}>
        ...
        <ScrollReveal>
          <div className="py-10 flex flex-col items-center gap-5">
            <span className="font-display text-sm font-700 tracking-wider uppercase" style={{ color: 'var(--accent)' }}>Sahil Dhanvij</span>
              ...
              {socials.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.backgroundColor = 'var(--accent-ghost)';
